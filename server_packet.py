...
#     file_chunks = []  # Initialize file_chunks outside the while loop
#     assembling_file = False  # Flag to indicate if currently assembling file chunks
#     filename = ""  # To store the filename of the currently processing file
...
#                 filename = message[len("START:"):].decode()
#                 assembling_file = True  # Start assembling file chunks
#                 file_chunks = []  # Reset/reinitialize file_chunks for the new file
#                 print(f"Starting to receive file: {filename}")

#             # Handle end of file transfer
#             elif message.startswith(b"END:") and assembling_file:
#                 assembling_file = False  # Stop assembling file chunks
#                 file_path = os.path.join(received_files_dir, filename)
#                 with open(file_path, "wb") as file:
#                     for chunk in file_chunks:
#                         file.write(chunk)
#                 print(f"File received and saved: {file_path}")
#                 filename = ""  # Reset filename for the next file
